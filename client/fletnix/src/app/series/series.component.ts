...
export class SeriesComponent implements OnInit {
  ...
  fetchCategories() {
    this.apiService.getCategories('TV Show').subscribe(categories => {
  ...
  loadContent() {
    ...
    this.apiService.getContent(profileId, this.currentPage, 'TV Show', this.selectedCategory ?? undefined).subscribe(
      (data) => {
        this.contents = data;
